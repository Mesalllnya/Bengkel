    ...
    do {
        ...
        switch (pilih) {
            ...
            case 2: buatPesanan(jmlhPesanan, nota, maksData); 
                break;
            case 3: listNota(jmlhPesanan, nota, maksData); 
                break;
            case 4: searching(); 
                break;
            case 5: editLayanan(); 
...
/*note buat 01-06-2025(done semua boskuh)
done    1. rencananya riwayat transaksinya bakalan di catat ke file
done    2. sebelum itu ada fitur hapus pesanan yang dipesan 
(done) 3. kalau hapus apa yang dipesan jika memesan sparepart maka stoknya akan bertambah sesuai dengan banyak jmlh yang diambil 
    4. jika sudah dimasukkan ke file (fitur sukses) diawal program baca riwayat transaksi aja dulu dengan jmlhPesanan sebagai batas banyaknya pesanan (sulit) jadi tidak usah dibaca langsung ditambah aja
done    5. abistuh otomatis stok sparepart juga akan berkurang (stok yang ada di file/database)
    */